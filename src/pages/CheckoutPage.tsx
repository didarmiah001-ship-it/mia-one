...
export function CheckoutPage() {
  ...
  const isRemote = (form as any).isRemoteArea || isRemoteDistrict;
  ...
  const expressAddOn = (form as any).isExpress && deliverySettings.express_enabled ? deliverySettings.express_delivery : 0;
  ...
  const handlePlaceOrder = async () => {
    ...
    if (paymentMethod === 'bkash' || paymentMethod === 'nagad' || paymentMethod === 'bank_transfer' || paymentMethod === 'bangla_qr') {
