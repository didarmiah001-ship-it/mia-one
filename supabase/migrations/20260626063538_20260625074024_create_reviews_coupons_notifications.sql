...
DROP POLICY IF EXISTS "coupons_select_auth" ON coupons;
...
DROP POLICY IF EXISTS "notifs_select_admin" ON notifications;
DROP POLICY IF EXISTS "notifs_insert_admin" ON notifications;
DROP POLICY IF EXISTS "notifs_update_admin" ON notifications;
DROP POLICY IF EXISTS "notifs_delete_admin" ON notifications;
...
DROP POLICY IF EXISTS "flash_sales_delete_admin" ON flash_sales;
